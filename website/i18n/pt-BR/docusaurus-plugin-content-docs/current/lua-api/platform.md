...
- Isso se destina a desvios baseados em plataforma, como selecionar artefatos
  de download.
- Valores comuns incluem `linux-amd64`, `linux-arm64`, `linux-x86`,
  `linux-arm`, `linux-riscv64`, `macos-amd64`, `macos-arm64` e
  `windows-amd64`.
