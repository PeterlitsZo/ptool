...
impl LuaWorld {
    ...
    pub(crate) fn etcd_connect(
        &self,
        options: Table,
    ) -> mlua::Result<crate::etcd::LuaEtcdConnection> {
        crate::etcd::connect(options, &self.engine)
    }
    ...
    pub(crate) fn fs_open(
        ...
        path: String,
        mode: Option<String>,
    ) -> mlua::Result<crate::fs::LuaFsFile> {
        crate::fs::open(&self.engine, path, mode)
    }
